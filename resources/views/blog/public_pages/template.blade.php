...
<body>
    <!-- WHITE HAEDER -->
    <header class="bg-dark position-fixed w-100 transition">
        <div class="d-flex p-4 container">
            ...
            <!-- RIGHT MENU -->
            <div class="bg-dark ms-auto d-lg-flex d-none gap-2">
        ...
        <div class="row gx-4 gy-4 mt-2">
            <div class="col-lg-6">
                <div class="card rounded-2">
                    <img class="w-100 object-fit-cover" style="height:200px;" src="{{ asset('img/bgpanjang.png') }}">
                    <div class="p-2">
                        <!-- Main Content-->
                        @yield('content')
                    </div>
