...
<body>
    ...
    <section class="container" style="padding-top:100px;">
        ...
        <div class="text-center">
            <h1>Promo Sepecial Untuk Anda</h1>
        </div>

        <div class="row gx-4 gy-4 mt-2">
            <div class="col-12">
                <div class="card rounded-2">
                    <img class="w-100 object-fit-cover" style="height:200px;" src="{{ asset('img/promo3.jpeg') }}">
                    <div class="p-2">
                        <h4>Ramadhan</h4>
                        <div>
                            Bulan suci yang penuh berkah, di mana umat Muslim menjalani ibadah puasa dan mendekatkan
                            diri kepada Allah. Keberkahan Ramadhan terpancar dalam setiap sahur dan berbuka, serta dalam
                            segala amal kebaikan yang dilakukan selama bulan ini.<br>
