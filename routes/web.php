...
use App\Http\Controllers\PublicPage2Controller;
...
Route::get('/', [WebblogController::class, 'webblog'])->name('webblog.');
Route::get('/location', [LocationController::class, 'index'])->name('location.index');
Route::get('/blog/public_pages', [PublicPage2Controller::class, 'homepage'])->name('blog.public_pages.homepage');
Route::get('/price', [PriceController::class, 'index'])->name('price.index');
Route::get('/galeri', [GaleriController::class, 'index'])->name('galeri.index');
Route::get('/promoblog', [PromoController::class, 'index'])->name('promoblog.index');
Route::get('/promo', [Promo2Controller::class, 'index'])->name('promo.index');
